...
class Times:
    def __init__(self, api_key, url, country='US', city='Tigard', state='OR'):
        ...
        self.fajir, self.duhur, self.asar, self.maghrib, \
            self.isha = self.get_times()
    ...
    def get_times(self):
        ...
        return fajir, dhuhr, asar, maghrib, isha

    def check_current_time(self):
        now = datetime.now()
        current_time = now.strftime("%I:%M %p")

        if current_time >= self.isha:
            return "Isha"
